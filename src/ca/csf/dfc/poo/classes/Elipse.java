...
/**
 * Classe représentant une elipse avec un point initial et un point final
 *  
 */
...
public class Elipse extends Shape{
	 ...
	 * @param 1 p_initialPoint point initial de l'elipse
	 * @param 2 p_finalPoint point final de l'elipse
	 * 
	 */
